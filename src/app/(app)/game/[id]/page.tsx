  ...
  const handleConfirmMysterySettings = async () => {
    ...
    try {
        ...
        if (gameRoom.joinType === 'remote') {
            const allPlayerIds = gameRoom.playerUIDs || Object.keys(gameRoom.players);
                    ...
                    <div className="py-4 space-y-6">
                        {currentQuestionInfo?.question?.imageUrl && (
                            <div className="relative aspect-video w-full">
                                <Image src={currentQuestionInfo.question.imageUrl} alt="질문 이미지" fill className="rounded-md object-contain" />
                            </div>
                        )}
